...
export default function RemoteTierPage({ params }: Props) {
  ...
  return (
    <main style={pageStyle}>
      ...
      <section style={panelStyle}>
        <h2 style={sectionTitleStyle}>Find the right fit</h2>

        <p style={cardBody}>
          Remote coaching options are recommended after a consultation so we can
          understand the athlete’s goals, schedule, training history, and level
          of support needed.
        </p>
